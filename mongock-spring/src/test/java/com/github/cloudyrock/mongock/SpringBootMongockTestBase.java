...
public class SpringBootMongockTestBase extends IndependentDbIntegrationTestBase {
  ...
  public final void setUpMockParent() {
    ...
    SpringBootMongock temp = new SpringBootMongock(changeEntryRepository, changeService, lockChecker, true, true, appContextMock, new MongoTemplate(mongoClient, "mongocktest"));
